  ...
  module Acts #:nodoc:
    module Taggable #:nodoc:
	  ...
	  tags = if tags.is_a?(String)
        ...
        #  :all_tags - when true, no taggable_type restrictions will be applied
        def tag_counts(options = {})
          options.assert_valid_keys :start_at, :end_at, :conditions, :at_least, :at_most, :order, :limit, :all_tags
          ...
          tagging_type=options[:all_tags] ? "taggings.taggable_type=taggings.taggable_type" : "taggings.taggable_type = #{quote_value(name)}" 
          conditions = [
            tagging_type,
            options[:conditions],
          ...
          Tag.find(:all,
            :select     => 'tags.id, tags.name, COUNT(*) AS count, taggings.taggable_type', 
